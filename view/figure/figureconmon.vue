            ...
            <div>
                <div class="box_centex">
                    <div class="left_contex">
                        ...
                        <h3 class="h_name">{{buildingParams.buildingName}}</h3>
                        <p>案例编号&nbsp;:&nbsp;&nbsp;<span>{{buildingParams.programmeId}}</span></p>
                ...
                <div class="all_button">
                   <!-- <div class="button_box button_margin">
                      ...
                      <div class="alet_container" v-show="showVideo">
                        <section class="tip_text_container">
                           <div class="rightClose">
                            ...
                            <video ref="eleVideo" :src="buildingParams.videoUrl" style="max-width: 100%;max-height: 700px;" controls></video>
                    ...
                    <div class="button_box button_margin" @click="handleWeb(1)" v-if="show_720 && buildingParams.panoramaUrl && buildingParams.panoramaAuditStatus==1">
...
export default {
  ...
  methods: {
    ...
    handleChangeRelativeSpace(data) {
      //   console.log(data, "handleChangeRelativeSpace");
    ...
    handleWeb(type) {
      ...
      var param = {
        ...
        panoramaImagePath: "",//720得Url
        figure720Type:'figure'
      };
      if (type == 0) {
        ...
        param.panoramaImagePath = this.buildingParams.panoramaUrl;
        //  param.panoramaImagePath ='http://vr.oceano.com.cn:6600/lib/krpano/krpano.html?xml=examples/mvtpano/krpano_vr2.xml&html5=only&catalog=build-web/dev/space/S0000001/vr';
        param.spaceName = this.buildingParams.buildingName;
        logScene720({
          spaceId: this.buildingParams.programmeId,
          panoramaImagePath: this.buildingParams.panoramaUrl
        });

      localStorage.setItem("figureUrl",this.buildingParams.panoramaUrl);
    ...
    handleFavorites(model) {
      console.log("model:效果图", model);
      console.log(this.$electron.remote.getGlobal("mac"), "效果图");
      let param = {
        mac: this.$electron.remote.getGlobal("mac"),
        entityUrl: this.getImgLocalSourceUrl(model.imageUrl),
        // entityId: model.programmeId,
        entityId: model.imageId,
        entityName: model.buildingName,
    ...
    ...mapActions("Favorites", {
      addFavorites: "addFigure", // 映射 this.addFavorites() to this.$store.dispatch('Favorites/addProduct')
        ...
        if (this.buildParamsFlag == true) {
          if (newVal.spaceId) {
            if (this.$route.query.figure_flag == 6) {
              ...
              if (newVal.videoUrl && newVal.videoAuditStatus == 1) {
                this.figureShowFlag = true;
              } else {
                this.figureShowFlag = false;
              }
              let relativeParams = {
